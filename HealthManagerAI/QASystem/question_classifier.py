...
class QuestionClassifier:
    def __init__(self):
        ...
        #　特征词路径
        self.disease_path = os.path.join(cur_dir, 'QASystem/dict/disease.txt')
        self.department_path = os.path.join(cur_dir, 'QASystem/dict/department.txt')
        self.check_path = os.path.join(cur_dir, 'QASystem/dict/check.txt')
        self.drug_path = os.path.join(cur_dir, 'QASystem/dict/drug.txt')
        self.food_path = os.path.join(cur_dir, 'QASystem/dict/food.txt')
        self.producer_path = os.path.join(cur_dir, 'QASystem/dict/producer.txt')
        self.symptom_path = os.path.join(cur_dir, 'QASystem/dict/symptom.txt')
        self.deny_path = os.path.join(cur_dir, 'QASystem/dict/deny.txt')
        # 加载特征词
